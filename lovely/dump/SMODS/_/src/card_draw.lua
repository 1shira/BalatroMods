LOVELY_INTEGRITY = 'cceb03a152f7a8553f8385fa2eef55dcdb848e672c61dc1712cf0991af2d0915'
...
SMODS.DrawStep {
    ...
    order = 70,
    func = function(self)
        if self.debuff or Cryptid.gameset(self) == 'disabled' or (self.config.center.gameset_config and self.config.center.gameset_config[Cryptid.gameset(self)] and self.config.center.gameset_config[Cryptid.gameset(self)].disabled) or (self.config.center.cry_disabled and not self.gameset_select) then
