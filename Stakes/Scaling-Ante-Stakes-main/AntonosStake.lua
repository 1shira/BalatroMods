...
SMODS.Stake({
    ...
    loc_txt = {
        ...
        text = {
            ...
            "eternal and rental Jokers appear in shop"
...
SMODS.Stake {
    ...
    key = "A_moredeath",
    above_stake = 'AntonosStake_A_death',
    applied_stakes = { "AntonosStake_A_death" },
    atlas = 'A_morestakes',
    sticker_atlas = 'morestickers',
    shiny = false,
    pos = { x = 4, y = 1 },
...
SMODS.Stake {
    ...
    key = "A_crazydeath",
    above_stake = 'AntonosStake_A_moredeath',
    applied_stakes = { "AntonosStake_A_moredeath" },
    atlas = 'A_crazystakes',
    sticker_atlas = 'crazystickers',
    shiny = false,
    pos = { x = 4, y = 1 },
